...
defcore="eina eet PROTO/eobj evas evas_generic_loaders ecore eio embryo edje emotion eeze
	e_dbus edbus efreet PROTO/libeweather PROTO/emap elementary ephysics"
