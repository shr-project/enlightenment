...
export BUILD_BASIC1="eina eet PROTO/eobj"
export BUILD_BASIC2="ecore embryo eio edje e_dbus efreet expedite "$BUILD_ETHUMB_OPTION" emotion ethumb "$BUILD_ELM_OPTION" elementary "$BUILD_E_OPTION" e"
...
export BUILD_ETC="terminology econnman exactness efx PROTO/shotgun editje PROTO/elev8 PROTO/eyelight FORMATTING/ecrustify ephoto edje_viewer PROTO/emap PROTO/azy elmdentica enlil PROTO/emote emprint clouseau PROTO/enna-explorer envision ensure enjoy exquisite rage PROTO/eyesight"
