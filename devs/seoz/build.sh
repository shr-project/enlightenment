...
export BUILD_ETC="terminology econnman exactness efx PROTO/shotgun editje PROTO/elev8 PROTO/eyelight ephoto edje_viewer PROTO/emap PROTO/azy elmdentica enlil PROTO/emote emprint clouseau PROTO/enna-explorer envision ensure enjoy exquisite rage PROTO/eyesight"
