...
export BUILD_BASIC1="efl" #eina eet eo embryo
export BUILD_BASIC2="ecore eio edje e_dbus efreet expedite "$BUILD_ETHUMB_OPTION" emotion ethumb "$BUILD_ELM_OPTION" elementary "$BUILD_E_OPTION" e"
