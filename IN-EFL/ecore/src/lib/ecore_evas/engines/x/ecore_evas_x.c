...
static const char *interface_xrender_x11_name = "xrender_x11";
static const int   interface_xrender_x11_version = 1;

static const char *interface_software_x11_8_name = "software_x11_8";
static const int   interface_software_x11_8_version = 1;

static const char *interface_software_x11_16_name = "software_x11_16";
static const int   interface_software_x11_16_version = 1;
...
EAPI Ecore_Evas *
ecore_evas_xrender_x11_new_internal(const char *disp_name EINA_UNUSED, Ecore_X_Window parent EINA_UNUSED,
...
static Ecore_X_Window
_ecore_evas_xrender_x11_window_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}
...
static void
_ecore_evas_xrender_x11_direct_resize_set(Ecore_Evas *ee EINA_UNUSED, Eina_Bool on EINA_UNUSED)
{
}

static Eina_Bool
_ecore_evas_xrender_x11_direct_resize_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}

static void
_ecore_evas_xrender_x11_extra_event_window_add(Ecore_Evas *ee EINA_UNUSED, Ecore_X_Window win EINA_UNUSED)
{
}

Ecore_Evas *
ecore_evas_software_x11_16_new_internal(const char *disp_name EINA_UNUSED, Ecore_X_Window parent EINA_UNUSED,
					int x EINA_UNUSED, int y EINA_UNUSED, int w EINA_UNUSED, int h EINA_UNUSED)
{
   return NULL;
}
...
static Ecore_X_Window
_ecore_evas_software_x11_16_window_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}
...
static void
_ecore_evas_software_x11_16_direct_resize_set(Ecore_Evas *ee EINA_UNUSED, Eina_Bool on EINA_UNUSED)
{
}

static Eina_Bool
_ecore_evas_software_x11_16_direct_resize_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}
...
static void
_ecore_evas_software_x11_16_extra_event_window_add(Ecore_Evas *ee EINA_UNUSED, Ecore_X_Window win EINA_UNUSED)
{
}

Ecore_Evas *
ecore_evas_software_x11_8_new_internal(const char *disp_name EINA_UNUSED, Ecore_X_Window parent EINA_UNUSED, int x EINA_UNUSED, int y EINA_UNUSED, int w EINA_UNUSED, int h EINA_UNUSED)
{
   return NULL;
}

static Ecore_X_Window
_ecore_evas_software_x11_8_window_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}
...
static Ecore_X_Window
_ecore_evas_software_x11_8_subwindow_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}

static void
_ecore_evas_software_x11_8_direct_resize_set(Ecore_Evas *ee EINA_UNUSED, Eina_Bool on EINA_UNUSED)
{
}

static Eina_Bool
_ecore_evas_software_x11_8_direct_resize_get(const Ecore_Evas *ee EINA_UNUSED)
{
   return 0;
}

static void
_ecore_evas_software_x11_8_extra_event_window_add(Ecore_Evas *ee EINA_UNUSED, Ecore_X_Window win EINA_UNUSED)
{
}
...
static Ecore_Evas_Interface_Software_X11_8 *
_ecore_evas_x_interface_software_x11_8_new(void)
{
   Ecore_Evas_Interface_Software_X11_8 *iface;

   iface = calloc(1, sizeof(Ecore_Evas_Interface_Software_X11_8));
   if (!iface) return NULL;

   iface->base.name = interface_software_x11_8_name;
   iface->base.version = interface_software_x11_8_version;

   iface->window_get = _ecore_evas_software_x11_8_window_get;
   iface->subwindow_get = _ecore_evas_software_x11_8_subwindow_get;
   iface->resize_set = _ecore_evas_software_x11_8_direct_resize_set;
   iface->resize_get = _ecore_evas_software_x11_8_direct_resize_get;
   iface->extra_event_window_add = _ecore_evas_software_x11_8_extra_event_window_add;

   return iface;
}

static Ecore_Evas_Interface_Software_X11_16 *
_ecore_evas_x_interface_software_x11_16_new(void)
{
   Ecore_Evas_Interface_Software_X11_16 *iface;

   iface = calloc(1, sizeof(Ecore_Evas_Interface_Software_X11_16));
   if (!iface) return NULL;

   iface->base.name = interface_software_x11_16_name;
   iface->base.version = interface_software_x11_16_version;

   iface->window_get = _ecore_evas_software_x11_16_window_get;
   iface->resize_set = _ecore_evas_software_x11_16_direct_resize_set;
   iface->resize_get = _ecore_evas_software_x11_16_direct_resize_get;
   iface->extra_event_window_add = _ecore_evas_software_x11_16_extra_event_window_add;
...
static Ecore_Evas_Interface_Xrender_X11 *
_ecore_evas_x_interface_xrender_x11_new(void)
{
   Ecore_Evas_Interface_Xrender_X11 *iface;

   iface = calloc(1, sizeof(Ecore_Evas_Interface_Xrender_X11));
   if (!iface) return NULL;

   iface->base.name = interface_xrender_x11_name;
   iface->base.version = interface_xrender_x11_version;

   iface->window_get = _ecore_evas_xrender_x11_window_get;
   iface->resize_set = _ecore_evas_xrender_x11_direct_resize_set;
   iface->resize_get = _ecore_evas_xrender_x11_direct_resize_get;
   iface->extra_event_window_add = _ecore_evas_xrender_x11_extra_event_window_add;
