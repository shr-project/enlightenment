...
if [ ! -z "$TARGET" ]; then
	...
	TARGETS="eina eet embryo evas ecore efreet edje e_dbus eeze e elementary E16 E-MODULES-EXTRA BINDINGS editje edje_viewer eio elmdentica emotion empower emprint enki enlil ensure ephoto eterm ethumb eve exalt EXAMPLES expedite exquisite imlib2 imlib2_loaders MISC $(ls PROTO | grep -v emote | while read d; do echo PROTO/$d; done) rage TEST"
fi
