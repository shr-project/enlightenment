...
/**
 * http://docs.enlightenment.org/auto/elementary/group__Icon.html
 */
var elementary = ["home",
                  "close",
                  "apps",
 ...
 */
var freedesktop = [ 'address-book-new',
                    'application-exit',
                    'appointment-new',
                    'call-start',
                    'call-stop',
...
for (var i = 0; i < elementary.length; ++i)
  grid_elements[i] = gengrid_item(elementary[i]);

for (var i = elementary.length; i < freedesktop.length; ++i)
  grid_elements[i] = gengrid_item(freedesktop[i]);
